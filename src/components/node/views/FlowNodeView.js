import { NodeViewBase } from "./base.js";
...
class FlowNodeView extends NodeViewBase {
    ...
    bindRemoveNode() {
        // close button
        this.el.querySelector(".node-close")
    ...
    bindInputPorts() {
        this.el.querySelectorAll(".flow-ports-in .flow-port")
            .forEach((port) => {
    ...
    bindOutputPorts() {
        this.el.querySelectorAll(".flow-ports-out .flow-port")
            .forEach((port) => {
